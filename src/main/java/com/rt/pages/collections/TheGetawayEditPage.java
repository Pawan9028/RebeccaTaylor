 ...
 * 
 * public class TheGetawayEditPage extends UtilityClass{
 * 
 * WebDriver driver; public TheGetawayEditPage(WebDriver driver) {
 ...
 * 
 * public void methodToOpenTheGetawayEditPage() { Actions action = new
 ...
 * methodToOpenTheGetawayEditPage(); loopForIsDisplayed(activeColorSwatch, 0);
 * loopForIsDisplayed(colorSwatch, 0); loopForIsEnabled(activeColorSwatch, 0);
 * loopForIsEnabled(colorSwatch, 0); Thread.sleep(10000); System.out.
 * println("Color swatches below the products on PLP is displayed and enabled."
 * ); }
 * 
 * public void verifyfiltersPresenceAndEnable() {
 * methodToOpenTheGetawayEditPage(); loopForIsDisplayed(filters, 0);
 ...
 * methodToOpenTheGetawayEditPage(); Assert.assertTrue(sortBy.isEnabled(),
 ...
 * methodToOpenTheGetawayEditPage(); for (int i = 0; i <
 ...
 * methodToOpenTheGetawayEditPage(); for (int i = 0; i < listOfProducts.size();
 * i++) { Assert.assertTrue(listOfProducts.get(i).isDisplayed(),
 ...
 * methodToOpenTheGetawayEditPage(); for (int i = 0; i < listOfQuickAdd.size();
 ...
 * 
 * public void verifyPageURL() { methodToOpenTheGetawayEditPage();
 * verifyPageURL("https://rebeccataylor.com/collections/the-getaway-edit"); }
 * 
 * public void verifyPageTitle() { methodToOpenTheGetawayEditPage();
 * verifyPageTitle("The Getaway Edit | Rebecca Taylor"); } public void
 * verifyPageLoadTimeOfThePage() { methodToOpenTheGetawayEditPage();
 * verifyPageLoadTime(); }
 * 
 * 
 * }
