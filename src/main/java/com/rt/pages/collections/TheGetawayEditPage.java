...
public class TheGetawayEditPage extends UtilityClass{
	...
	WebDriver driver;
	public TheGetawayEditPage(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void methodToOpenTheGetawayEditPage() {
	...
	public void verifyColorSwatchesPresenceAndEnable() throws InterruptedException {
		methodToOpenTheGetawayEditPage();
	...
	public void verifyPageTitle() {
		methodToOpenTheGetawayEditPage();
		verifyPageTitle("The Getaway Edit | Rebecca Taylor");
	}
