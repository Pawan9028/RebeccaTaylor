...
public class WorkwearEdit_Page extends UtilityClass{
	
	WebDriver driver;

	public WorkwearEdit_Page(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void methodToOpenTheWorkwearEditPage() {
		Actions action = new Actions(driver);
		action.moveToElement(collectionsTab).build().perform();
		listOfMegaMenu.get(7).click();
	}
	...
	public void verifyColorSwatchesPresenceAndEnable() throws InterruptedException {
		pop_up_Handle();
		methodToOpenTheWorkwearEditPage();
	...
	public void verifyProductPricesPresence() throws InterruptedException {
		...
		/*
		 * Thread.sleep(1000); showMoreProductButton.click(); Thread.sleep(1000);
		 * loopForIsDisplayed(listOfProductPrice, 20); Thread.sleep(1000);
	...
	public void verifyPageURL() throws InterruptedException {
		pop_up_Handle();
		methodToOpenTheWorkwearEditPage();
		verifyPageURL("https://rebeccataylor.com/collections/workwear-edit");
	}

	public void verifyPageTitle() throws InterruptedException {
		pop_up_Handle();
		methodToOpenTheWorkwearEditPage();
		verifyPageTitle("Workwear Edit – Rebecca Taylor");
	}
