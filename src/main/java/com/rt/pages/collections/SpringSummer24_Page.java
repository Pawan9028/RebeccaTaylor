...
public class SpringSummer24_Page extends UtilityClass{

	WebDriver driver;
	public SpringSummer24_Page(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void methodToOpenTheSpringPage() {
		Actions action = new Actions(driver);
		action.moveToElement(collectionsTab).build().perform();
		listOfMegaMenu.get(5).click();
	}
	...
	public void verifyPageURL() throws InterruptedException {
		pop_up_Handle();
		methodToOpenTheSpringPage();
		verifyPageURL("https://rebeccataylor.com/collections/fw24");
	}

	public void verifyPageTitle() throws InterruptedException {
		pop_up_Handle();
		methodToOpenTheSpringPage();
		verifyPageTitle("FW24 – Rebecca Taylor");
	}
