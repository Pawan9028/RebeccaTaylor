...
public class ViewAllPage extends UtilityClass{
	...
	@FindBy(xpath = "//span[text()='CLOTHING']") WebElement clothingTab;
	...
	@FindBy(xpath = "//div[@class='card-information']/div[@class='card-information__wrapper text-center']/h3/a")
	...
	public void methodToOpenTheViewAllPage() {
		Actions action = new Actions(driver);
		action.moveToElement(clothingTab).build().perform();
		listOfMegaMenu.get(4).click();
	}
	...
	public void verifyProductPricesPresence() throws InterruptedException {
		...
		for (int i = 0; i < listOfProductPrice.size(); i++) {
		  ...
		  Thread.sleep(1000);
		 loopForIsDisplayed(listOfProductPrice, 20); 
		 Thread.sleep(1000);
		 /* showMoreProductButton.click(); Thread.sleep(1000);
		 * loopForIsDisplayed(listOfProductPrice, 40); Thread.sleep(1000);
		 * showMoreProductButton.click(); Thread.sleep(1000);
		 * loopForIsDisplayed(listOfProductPrice, 60); Thread.sleep(1000);
		 * showMoreProductButton.click(); Thread.sleep(1000);
		 * loopForIsDisplayed(listOfProductPrice, 80); Thread.sleep(1000);
		 * showMoreProductButton.click(); Thread.sleep(10000);
		 * loopForIsDisplayed(listOfProductPrice, 100);
		 */
	...
	public void verifyProductsQuickAddEnable() throws InterruptedException {
		...
		Thread.sleep(10000);
		listOfProductSize.get(12).click();
		Thread.sleep(10000);
		viewBag.click();
		//Thread.sleep(10000);
	...
	public void verifyPageURL() throws InterruptedException {
		pop_up_Handle();
		methodToOpenTheViewAllPage();
		verifyPageURL("https://rebeccataylor.com/collections/shop-all");
	}

	public void verifyPageTitle() throws InterruptedException {
		pop_up_Handle();
		methodToOpenTheViewAllPage();
		verifyPageTitle("Women's Designer Clothing & Dresses | Rebecca Taylor");
	}
