...
public class JacketsPage extends UtilityClass{
	...
	public void methodToOpenTheJacketsPage() {
		Actions action = new Actions(driver);
		action.moveToElement(clothingTab).build().perform();
		listOfMegaMenu.get(3).click();
	}
	...
	public void verifyProductPricesPresence() throws InterruptedException {
		...
		/*
		 * Thread.sleep(10000); showMoreProductButton.click(); Thread.sleep(10000);
	...
	public void verifyProductNamePresence() throws InterruptedException {
		 ...
		 * loopForIsDisplayed(listOfProducts, 20);
		 */
	...
	public void verifyPageURL() throws InterruptedException {
		pop_up_Handle();
		methodToOpenTheJacketsPage();
		verifyPageURL("https://rebeccataylor.com/collections/jackets");
	}

	public void verifyPageTitle() throws InterruptedException {
		pop_up_Handle();
		methodToOpenTheJacketsPage();
		verifyPageTitle("Women's Blazers, Jackets & Coats | Rebecca Taylor");
	}
