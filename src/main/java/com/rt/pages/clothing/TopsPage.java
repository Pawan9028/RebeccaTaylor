...
public class TopsPage extends UtilityClass{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
	public void methodToOpenTheTopsPage() {
		Actions action = new Actions(driver);
		action.moveToElement(clothingTab).build().perform();
		listOfMegaMenu.get(0).click();
	}
	...
	public void verifyPageURL() throws InterruptedException {
		pop_up_Handle();
		methodToOpenTheTopsPage();
		verifyPageURL("https://rebeccataylor.com/collections/tops");
	}

	public void verifyPageTitle() throws InterruptedException {
		pop_up_Handle();
		methodToOpenTheTopsPage();
		verifyPageTitle("Women's Tops & Blouses | Rebecca Taylor");
	}
