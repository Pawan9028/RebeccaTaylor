...
public class BottomsPage extends UtilityClass{
	...
	public void methodToOpenTheBottomsPage() {
		Actions action = new Actions(driver);
		action.moveToElement(clothingTab).build().perform();
		listOfMegaMenu.get(2).click();	
	}
	...
	/*
	 * public void verifyfiltersPresenceAndEnable() { methodToOpenTheBottomsPage();
	 ...
	 * methodToOpenTheBottomsPage(); Assert.assertTrue(sortBy.isEnabled(),
	...
	public void verifyPageURL() throws InterruptedException {
		pop_up_Handle();
		methodToOpenTheBottomsPage();
		verifyPageURL("https://rebeccataylor.com/collections/bottoms");
	}

	public void verifyPageTitle() throws InterruptedException {
		pop_up_Handle();
		methodToOpenTheBottomsPage();
		verifyPageTitle("Women's Bottoms, Trousers & Skirts | Rebecca Taylor");
	}
