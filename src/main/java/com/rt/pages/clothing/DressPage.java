...
public class DressPage extends UtilityClass{
	...
	public void methodToOpenTheDressPage() {
		Actions action = new Actions(driver);
		action.moveToElement(clothingTab).build().perform();
		listOfMegaMenu.get(1).click();
	}
	...
	public void verifyColorSwatchesPresenceAndEnable() throws InterruptedException {
		 ...
		 * loopForIsDisplayed(activeColorSwatch, 20); loopForIsDisplayed(colorSwatch,
		 * 20); loopForIsEnabled(activeColorSwatch, 20); loopForIsEnabled(colorSwatch,
		 * 20);
		 */
	...
	public void verifyProductNamePresence() throws InterruptedException {
		...
		Thread.sleep(10000);
		/*
		 * showMoreProductButton.click(); loopForIsDisplayed(listOfProducts, 20);
		 */
	...
	public void verifyPageURL() throws InterruptedException {
		pop_up_Handle();
		methodToOpenTheDressPage();
		verifyPageURL("https://rebeccataylor.com/collections/dresses");
	}

	public void verifyPageTitle() throws InterruptedException {
		pop_up_Handle();
		methodToOpenTheDressPage();
		verifyPageTitle("Women's Mini, Midi & Maxi Dresses | Rebecca Taylor");
	}
