...
import com.rt.pages.collections.WorkwearEdit_Page;

public class WorkwearEdit_Test extends BaseClass{

	WorkwearEdit_Page obj;
	
	@BeforeMethod
	public void loadObject() {
		obj = new WorkwearEdit_Page(driver);
	}
	@Test
