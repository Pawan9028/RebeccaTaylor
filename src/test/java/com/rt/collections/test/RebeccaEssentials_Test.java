...
import com.rt.pages.collections.RebeccaEssentialsPage;

public class RebeccaEssentials_Test extends BaseClass{
	
	RebeccaEssentialsPage obj;
	
	@BeforeMethod
	public void loadObject() {
		obj = new RebeccaEssentialsPage(driver);
	}
	@Test
